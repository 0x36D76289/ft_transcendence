...
<div class="popup ${type}">
	...
	const removePopup = () => {
		popupElement.style.animation = 'popupExit 0.4s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards';

		// Reposition other popups
		const currentIndex = Array.from(document.querySelectorAll('.popup')).indexOf(popupElement);
